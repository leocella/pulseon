...
CREATE TABLE IF NOT EXISTS public.queue_events (
    ...
    performed_by TEXT NOT NULL, -- Nome do atendente
    guiche TEXT, -- Guichê/sala onde foi chamado
    motivo TEXT, -- Motivo (obrigatório para SKIP e CANCEL)
...
BEGIN
    ...
    -- Isso previne condição de corrida (race condition)
